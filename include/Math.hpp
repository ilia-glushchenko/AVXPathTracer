...
namespace
{
	...
	inline __forceinline math::Vector4x4f xxxxDot16fromMuls(
		__m512 aMulB0, __m512 aMulB1, __m512 aMulB2, __m512 aMulB3
	)
	{
		__m128 const xxxx0 = _mm512_castps512_ps128(aMulB0);
		__m128 const yyyy0 = _mm512_extractf32x4_ps(aMulB0, 1);
		__m128 const zzzz0 = _mm512_extractf32x4_ps(aMulB0, 2);
		__m128 const wwww0 = _mm512_extractf32x4_ps(aMulB0, 3);

		__m128 const xxxx1 = _mm512_castps512_ps128(aMulB1);
		__m128 const yyyy1 = _mm512_extractf32x4_ps(aMulB1, 1);
		__m128 const zzzz1 = _mm512_extractf32x4_ps(aMulB1, 2);
		__m128 const wwww1 = _mm512_extractf32x4_ps(aMulB1, 3);

		__m128 const xxxx2 = _mm512_castps512_ps128(aMulB2);
		__m128 const yyyy2 = _mm512_extractf32x4_ps(aMulB2, 1);
		__m128 const zzzz2 = _mm512_extractf32x4_ps(aMulB2, 2);
		__m128 const wwww2 = _mm512_extractf32x4_ps(aMulB2, 3);

		__m128 const xxxx3 = _mm512_castps512_ps128(aMulB3);
		__m128 const yyyy3 = _mm512_extractf32x4_ps(aMulB3, 1);
		__m128 const zzzz3 = _mm512_extractf32x4_ps(aMulB3, 2);
		__m128 const wwww3 = _mm512_extractf32x4_ps(aMulB3, 3);
...
namespace math
{
	...
	inline Vector4x4f Sub4(Vector4x4f a, Vector4x4f b)
	{
		return _mm512_sub_ps(a, b);
	}

	inline Vector4x4f Sub4S(Vector4x4f a, float s)
	{
		__m512 const scalar = _mm512_set1_ps(s);
		return _mm512_sub_ps(a, scalar);
	}

	inline Vector4x4f Add4(Vector4x4f a, Vector4x4f b)
	{
		return _mm512_add_ps(a, b);
	}

	inline Vector4x4f Add4S(Vector4x4f a, float s)
	{
		__m512 const scalar = _mm512_set1_ps(s);
		return _mm512_add_ps(a, scalar);
	}

	inline Vector4x4f Mul4(Vector4x4f a, Vector4x4f b)
	{
		return _mm512_mul_ps(a, b);
	}

	inline Vector4x4f Mul4S(Vector4x4f a, float s)
	{
		__m512 const scalar = _mm512_set1_ps(s);
		return _mm512_mul_ps(a, scalar);
	}
	...
	namespace xxxx
	{
		...
		{
			__m512 const aMulB0 = _mm512_mul_ps(v0_0, v0_1);
			__m512 const aMulB1 = _mm512_mul_ps(v1_0, v1_1);
			__m512 const aMulB2 = _mm512_mul_ps(v2_0, v2_1);
			__m512 const aMulB3 = _mm512_mul_ps(v3_0, v3_1);

			return ::xxxxDot16fromMuls(aMulB0, aMulB1, aMulB2, aMulB3);
		}
		...
		{
			__m512 const b = _mm512_castps128_ps512(v_1);

			__m512 const aMulB0 = _mm512_mul_ps(v0_0, b);
			__m512 const aMulB1 = _mm512_mul_ps(v0_1, b);
			__m512 const aMulB2 = _mm512_mul_ps(v0_2, b);
			__m512 const aMulB3 = _mm512_mul_ps(v0_3, b);

			return ::xxxxDot16fromMuls(aMulB0, aMulB1, aMulB2, aMulB3);
		}

		inline void Normalize16Restricted(
			Vector4x4f& __restrict v0,
			Vector4x4f& __restrict v1,
			Vector4x4f& __restrict v2,
			Vector4x4f& __restrict v3
		)
		{
			Vector4x4f const lenghts = _mm512_rsqrt14_ps(Dot16x16(v0, v0, v1, v1, v2, v2, v3, v3));
	...
	namespace xyzw
	{
		...
		inline Vector4f Cross(Vector4f a, Vector4f b)
		{
			...
			__m128 const b_yzx = _mm_shuffle_ps(b, b, _MM_SHUFFLE(3, 0, 2, 1));
			__m128 const c = _mm_sub_ps(_mm_mul_ps(a, b_yzx), _mm_mul_ps(a_yzx, b));
			return _mm_shuffle_ps(c, c, _MM_SHUFFLE(3, 0, 2, 1));
		}

		inline Vector4x4f Cross4(Vector4x4f a, Vector4x4f b)
		{
			__m512 const a_yzx = _mm512_shuffle_ps(a, a, _MM_SHUFFLE(3, 0, 2, 1));
			__m512 const b_yzx = _mm512_shuffle_ps(b, b, _MM_SHUFFLE(3, 0, 2, 1));
			__m512 const c = _mm512_sub_ps(_mm512_mul_ps(a, b_yzx), _mm512_mul_ps(a_yzx, b));
		...
		{
			__m512 const vSq = _mm512_mul_ps(v, v);
			...
			__m128 const lengths = _mm_sqrt_ps(_mm_add_ps(_mm_add_ps(_mm_add_ps(a, b), c), d));
		...
		inline Vector4x4f Sub4x1(Vector4x4f a, Vector4f b)
		{
			__m512 const c = _mm512_broadcast_f32x4(b);
			return _mm512_sub_ps(a, c);
		}
		...
		inline Vector4x4f Add4x1(Vector4x4f a, Vector4f b)
		{
			__m512 const c = _mm512_broadcast_f32x4(b);
